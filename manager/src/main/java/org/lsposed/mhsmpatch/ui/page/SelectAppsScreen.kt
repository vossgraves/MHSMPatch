...
import org.lsposed.mhsmpatch.ui.component.SearchAppBar
import org.lsposed.mhsmpatch.ui.viewmodel.SelectAppsViewModel
...
fun SelectAppsScreen(
    ...
    LaunchedEffect(Unit) {
        ...
        initialSelected?.let {
            ...
            viewModel.multiSelected.addAll(MHSMPackageManager.appList.filter { tmp.contains(it.app.packageName) })
        }
    }
    ...
    LazyColumn {
        items(
            ...
            AppItem(
                ...
                icon = MHSMPackageManager.getIcon(it),
                label = it.label,
