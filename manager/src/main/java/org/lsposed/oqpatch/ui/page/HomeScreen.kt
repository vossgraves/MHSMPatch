...
private fun InfoCard() {
    ...
    ElevatedCard {
        Column(
            ...
            infoCardContent(stringResource(R.string.home_oqpatch_version) to LSPConfig.instance.VERSION_NAME + " (${LSPConfig.instance.VERSION_CODE})")
            ...
            TextButton(
                ...
                onClick = {
                    ...
                    cm.setPrimaryClip(ClipData.newPlainText("OQPatch", contents.toString()))
        ...
        Column(
            ...
            HtmlText(
                stringResource(
                    ...
                    "<b><a href=\"https://github.com/JingMatrix/OQPatch\">GitHub</a></b>",
