...
import org.lsposed.oqpatch.ui.component.SearchAppBar
import org.lsposed.oqpatch.ui.viewmodel.SelectAppsViewModel
...
fun SelectAppsScreen(
    ...
    LaunchedEffect(Unit) {
        ...
        initialSelected?.let {
            ...
            viewModel.multiSelected.addAll(OQPackageManager.appList.filter { tmp.contains(it.app.packageName) })
        }
    }
    ...
    LazyColumn {
        items(
            ...
            AppItem(
                ...
                icon = OQPackageManager.getIcon(it),
                label = it.label,
