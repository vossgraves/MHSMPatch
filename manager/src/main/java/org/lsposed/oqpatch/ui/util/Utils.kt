package org.lsposed.oqpatch.ui.util
...
fun checkIsApkFixedByLSP(context: Context, packageName: String): Boolean {
    return try {
        ...
        (app.metaData?.containsKey("oqpatch") != true)
    } catch (_: PackageManager.NameNotFoundException) {
        Log.e("OQPatch", "Package not found: $packageName")
        false
    } catch (e: Exception) {
        Log.e("OQPatch", "Unexpected error in checkIsApkFixedByLSP", e)
        false
    }
}
