...
public class OriginApkHelper {
    ...
    private static final String TAG = "MHSMPatch-ApkHelper";
    private static final int PER_USER_RANGE = 100000;

    public static Path prepareOriginApk(ApplicationInfo appInfo, ClassLoader baseClassLoader) throws IOException {
        Path internalOriginDir = Paths.get(appInfo.dataDir, "cache/mhsmpatch/origin/");
        ...
        Path externalOriginPath = Paths.get("/storage/emulated/" + userId + "/Android/data/" + appInfo.packageName + "/cache/mhsmpatch/origin/origin.apk");
